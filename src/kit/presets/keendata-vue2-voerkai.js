...
const preset = {
  ...
  rules: {
    ...
    bootstrap: {
     ...
     scopeSymbol: "i18nScope",
      mixinImport: "@/mixins/i18n-mixin",
      mixinSymbol: "i18nMixin",
   ...
   rtl: {
     ...
     dirAttributeTarget: "document.documentElement.dir",
      mixinFile: "src/mixins/i18n-mixin.js",
  ...
  widthAdaptation: {
    ...
    displayName: {
      mixinFile: "src/mixins/i18n-mixin.js",
      utilsFile: "src/utils/i18n.js",
      methods: ["displayNameConfig", "displayNameLabel"],
      defaultChLabel: "中文名称",
      defaultOtherLabel: "显示名称",
      requiresIsZh: true,
    },
    specialComponents: [
      {
    ...
    layoutHeader: {
      ...
      languageSwitcherProps: ["activeLanguage", "languages", "languageChange"],
    },
    validation: {
